...
|-------|-------|
| Hostname | `g4-pc3-vm1` |
| FQDN | `g4-pc3-vm1.grupo4-bsi-26-1.maceio.lab` |
| Apelido (alias) | `g4-pc3-vm1` |
| Endereço IP | `192.168.26.53/28` |
...
```text
127.0.0.1   localhost
127.0.1.1   g4-pc3-vm1.grupo4-bsi-26-1.maceio.lab   g4-pc3-vm1
...
[Acessar pasta no Google Drive](https://drive.google.com/drive/folders/1qJx5j3jgNtI6wKyUmlToczt6_1puKOFR?usp=sharing)
