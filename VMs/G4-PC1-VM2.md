...
|-------|-------|
| Hostname | `g4-pc1-vm2` |
| FQDN | `g4-pc1-vm2.grupo4-bsi-26-1.maceio.lab` |
| Apelido (alias) | `g4-pc1-vm2` |
| Endereço IP | `192.168.26.50/28` |
...
```text
127.0.0.1   localhost
127.0.1.1   g4-pc1-vm2.grupo4-bsi-26-1.maceio.lab   g4-pc1-vm2
...
[Acessar pasta no Google Drive](https://drive.google.com/drive/folders/1zmxh9Y0jnmjT-2bo8SW9UlXNK4kJbKba?usp=sharing)
