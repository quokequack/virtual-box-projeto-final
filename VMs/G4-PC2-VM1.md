...
|-------|-------|
| Hostname | `g4-pc2-vm1` |
| FQDN | `g4-pc2-vm1.grupo4-bsi-26-1.maceio.lab` |
| Apelido (alias) | `g4-pc2-vm1` |
| Endereço IP | `192.168.26.51/28` |
...
```text
127.0.0.1   localhost
127.0.1.1   g4-pc2-vm1.grupo4-bsi-26-1.maceio.lab   g4-pc2-vm1
...
[Acessar pasta no Google Drive](https://drive.google.com/drive/folders/1m0n9oJ1oznculPeF8tXZQMImii66vPte?usp=sharing)
